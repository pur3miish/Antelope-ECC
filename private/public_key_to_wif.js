 ...
 * @param {boolean} [legacy] Indicated if the public key should be returned in legacy format i.e starts with EOS.
 * @returns {string} WIF public key.
 * @ignore
 */
async function public_key_to_wif(raw_public_key, legacy = true) {
  const hash = legacy
