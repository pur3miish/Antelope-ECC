...
import new_keys from '../new_keys.js'
import public_key_from_private from '../public_key_from_private.js'
import recover_public_key from '../recover_public_key_from_signature.js'
...
export default tests => {
  tests.add('recover public key from signature', async () => {
    ...
    const SIG = await sign_txn({
      hex: 'aaaa',
      wif_private_key: 'PVT_K1_SkB92YpWm4Q1NLo8prcWuTogeiEehW583FT8APBTPSeMiZnh'
    })
